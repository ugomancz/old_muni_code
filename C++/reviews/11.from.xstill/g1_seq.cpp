...
template< typename T >
class seq {
    /** držet si materializovanou senkvenci je v této úloze zbytečné, navíc
     ** pokud to děláte, tak seq_iterator vůbec nepotřebujete. Smyslem bylo
     ** naprogramovat líný iterátor, který si drží jen danou jednu hodnotu **/
    std::vector<T> _seq;
