...
class natural {
    /** ukládat si desítkové číslice do 64bitového datového typu je velmi
     ** neefektivní, využíváte 4 bity z 64 **/
    ...
    /** dávalo by větší smysl jako privátní statická metoda (friend není nikdy
     ** private) **/
    /** tohle by si zasloužilo komentář… co znamená small a jak se tato funkce
     ** liší od té následující? **/
    friend std::pair<natural, natural> small_div_mod(natural dividend, const natural &divisor);

    /** dávalo by větší smysl jako privátní statická metoda **/
