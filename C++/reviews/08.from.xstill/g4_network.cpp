...
public:
    void react(event e) override {
        /** Tohle má jednu nevýhodu – když implementátor potomka zapomene na
         ** toto volání, tak se to celé rozbije. Bezpečnější alternativa by byla
         ** mít metodu ‹react› nevirtuální a volat z ní virtuální pomocnou
         ** metodu která implementuje jen ty části, které se mezi různými uzly
         ** liší. **/
        react_counter(e);
