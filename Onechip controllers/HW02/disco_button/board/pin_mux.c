...
- {pin_num: B1, pin_signal: PTD12/SPI2_SCK/FTM3_FLT0/SDHC0_D4/FB_A20, label: 'J2[19]/FB_A20', identifier: FB_A20;BTN_LEFT}
...
- {pin_num: C3, pin_signal: PTD13/SPI2_SOUT/SDHC0_D5/FB_A21, label: 'J2[17]/FB_A21', identifier: BTN_INPUT;BTN_RIGHT}
...
- pin_list:
  ...
  - {pin_num: M9, peripheral: GPIOA, signal: 'GPIO, 10', pin_signal: PTA10/LLWU_P22/FTM2_CH0/MII0_RXD2/FTM2_QD_PHA/TPM2_CH0/TRACE_D0, direction: INPUT, gpio_interrupt: kPORT_InterruptFallingEdge,
    pull_select: up, pull_enable: enable}
  - {pin_num: B1, peripheral: GPIOD, signal: 'GPIO, 12', pin_signal: PTD12/SPI2_SCK/FTM3_FLT0/SDHC0_D4/FB_A20, identifier: BTN_LEFT, direction: INPUT}
  - {pin_num: C3, peripheral: GPIOD, signal: 'GPIO, 13', pin_signal: PTD13/SPI2_SOUT/SDHC0_D5/FB_A21, identifier: BTN_RIGHT, direction: INPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitBUTTONsPins(void)
{
    ...
    gpio_pin_config_t BTN_LEFT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD12 (pin B1)  */
    GPIO_PinInit(BOARD_BTN_LEFT_GPIO, BOARD_BTN_LEFT_PIN, &BTN_LEFT_config);

    gpio_pin_config_t BTN_RIGHT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD13 (pin C3)  */
    GPIO_PinInit(BOARD_BTN_RIGHT_GPIO, BOARD_BTN_RIGHT_PIN, &BTN_RIGHT_config);
    ...
    PORT_SetPinMux(BOARD_BTN_LEFT_PORT, BOARD_BTN_LEFT_PIN, kPORT_MuxAsGpio);

    /* PORTD13 (pin C3) is configured as PTD13 */
    PORT_SetPinMux(BOARD_BTN_RIGHT_PORT, BOARD_BTN_RIGHT_PIN, kPORT_MuxAsGpio);
}
