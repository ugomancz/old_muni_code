...
/* Symbols to be used with GPIO driver */
#define BOARD_BTN_LEFT_GPIO GPIOD                /*!<@brief GPIO peripheral base pointer */
#define BOARD_BTN_LEFT_GPIO_PIN_MASK (1U << 12U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_BTN_LEFT_PORT PORTD                /*!<@brief PORT peripheral base pointer */
#define BOARD_BTN_LEFT_PIN 12U                   /*!<@brief PORT pin number */
#define BOARD_BTN_LEFT_PIN_MASK (1U << 12U)      /*!<@brief PORT pin mask */
                                                 /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_BTN_RIGHT_GPIO GPIOD                /*!<@brief GPIO peripheral base pointer */
#define BOARD_BTN_RIGHT_GPIO_PIN_MASK (1U << 13U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_BTN_RIGHT_PORT PORTD                /*!<@brief PORT peripheral base pointer */
#define BOARD_BTN_RIGHT_PIN 13U                   /*!<@brief PORT pin number */
#define BOARD_BTN_RIGHT_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                                  /* @} */
