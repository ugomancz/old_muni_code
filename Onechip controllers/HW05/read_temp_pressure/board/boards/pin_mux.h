...
/* Symbols to be used with PORT driver */
#define BOARD_FB_AD10_PORT PORTC               /*!<@brief PORT peripheral base pointer */
#define BOARD_FB_AD10_PIN 5U                   /*!<@brief PORT pin number */
#define BOARD_FB_AD10_PIN_MASK (1U << 5U)      /*!<@brief PORT pin mask */
                                               /* @} */
